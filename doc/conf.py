...
htmlhelp_basename = 'HolaMundodoc'
...
latex_documents = [
    (index_doc, 'HolaMundo.tex', u'Hola Mundo Documentation',
...
man_pages = [
    (index_doc, 'HolaMundo', u'Hola Mundo Documentation',
     [u'Raul Gonzalez'], 1)
]
...
texinfo_documents = [
    (index_doc, 'k', u'Hola Mundo Documentation',
     u'Raul Gonzalez', 'Hola Mundo!', 'Sanitarium Inc.',
     'Miscellaneous'),
]
